...
function HW8() {
    const [people, setPeople] = useState<Person[]>(initialPeople) // need to fix any

    // need to fix any
    const finalPeople = people ? people.map((p: Person) => (
    ...
    const sortDown = () => setPeople(homeWorkReducer(initialPeople, { type: 'down', payload: 'down' }))
